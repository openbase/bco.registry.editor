...
public class AgentConfigColumn extends ValueColumn {
    ...
    public AgentConfigColumn(AgentRegistryRemote agentRegistryRemote, LocationRegistryRemote locationRegistryRemote, ReadOnlyDoubleProperty windowWidthProperty) {
