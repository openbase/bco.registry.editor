 ...
 */
public class DeviceClassComboBoxConverter implements MessageComboBoxConverter {
    ...
    public String getValue(Message msg) {
        return (String) msg.getField(ProtoBufFieldProcessor.getFieldDescriptor(DeviceClass.getDefaultInstance(), DeviceClass.ID_FIELD_NUMBER));
    }
}
